    ...
    public class SlotWithType : Slot {
        ...
        public override void OnDrop(PointerEventData eventData) {
            ...
            if (itemType.ItemType == Type) {
                ...
                playerInventory.helmet = Item._item as HelmetItem;
                playerInventory.helmetSlotManager.LoadHelmetOnSlot(playerInventory.helmet);
                Debug.Log(base.Item._item as HelmetItem);
            } else {
                eventData.Use();
            }
        }
